...
//#define AccountCurrency() AccountInfoString(ACCOUNT_CURRENCY)
//+------------------------------------------------------------------+
//|                                                                  |
//+------------------------------------------------------------------+
   ...
   switch(type)
     {
      ...
      case MODE_TIME:
         return((int)SymbolInfoInteger(symbol,SYMBOL_TIME));
      case MODE_BID:
         return(Bid);
      case MODE_ASK:
         return(Ask);
      ...
      case MODE_SWAPTYPE:
         return((int)SymbolInfoInteger(symbol,SYMBOL_SWAP_MODE));
      case MODE_PROFITCALCMODE:
         return((int)SymbolInfoInteger(symbol,SYMBOL_TRADE_CALC_MODE));
